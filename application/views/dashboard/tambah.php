               ...
               <form action="" method="POST">
                    ...
                    <div class="form-group row">
                         <div class="form-group col-sm">
                              ...
                              <input type="number" step="0.1" min="1.8" max="4.0" class="form-control form-control-sm" id="gph1" name="gph1" value="<?= set_value('gph1'); ?>">
                              <?= form_error('gph1', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="gph2">GPH 2</label>
                              <input type="number" step="0.1" min="1.8" max="4.0" class="form-control form-control-sm" id="gph2" name="gph2" value="<?= set_value('gph2'); ?>">
                              <?= form_error('gph2', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="gph3">GPH 3</label>
                              <input type="number" step="0.1" min="1.8" max="4.0" class="form-control form-control-sm" id="gph3" name="gph3" value="<?= set_value('gph3'); ?>">
                              <?= form_error('gph3', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="gph4">GPH 4</label>
                              <input type="number" step="0.1" min="1.8" max="4.0" class="form-control form-control-sm" id="gph4" name="gph4" value="<?= set_value('gph4'); ?>">
                              <?= form_error('gph4', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="gph5">GPH 5</label>
                              <input type="number" step="0.1" min="1.8" max="4.0" class="form-control form-control-sm" id="gph5" name="gph5" value="<?= set_value('gph5'); ?>">
                    ...
                    <div class="form-group row">
                         <div class="form-group col-sm">
                              ...
                              <input type="number" min="1" max="6" class="form-control form-control-sm" id="regulator1_bp1" name="regulator1_bp1" value="<?= set_value('regulator1_bp1'); ?>">
                              <?= form_error('regulator1_bp1', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="regulator2_bp1">Regulator 2</label>
                              <input type="number" min="1" max="6" class="form-control form-control-sm" id="regulator2_bp1" name="regulator2_bp1" value="<?= set_value('regulator2_bp1'); ?>">
                              <?= form_error('regulator2_bp1', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="regulator3_bp1">Regulator 3</label>
                              <input type="number" min="1" max="3" class="form-control form-control-sm" id="regulator3_bp1" name="regulator3_bp1" value="<?= set_value('regulator3_bp1'); ?>">
                              <?= form_error('regulator3_bp1', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="regulator4_bp1">Regulator 4</label>
                              <input type="number" min="1" max="5" class="form-control form-control-sm" id="regulator4_bp1" name="regulator4_bp1" value="<?= set_value('regulator4_bp1'); ?>">
                              <?= form_error('regulator4_bp1', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="regulator5_bp1">Regulator 5</label>
                              <input type="number" min="1" max="5" class="form-control form-control-sm" id="regulator5_bp1" name="regulator5_bp1" value="<?= set_value('regulator5_bp1'); ?>">
                              <?= form_error('regulator5_bp1', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="mainMotor_bp1">Main Motor</label>
                              <input type="number" min="1" max="50" class="form-control form-control-sm" id="mainMotor_bp1" name="mainMotor_bp1" value="<?= set_value('mainMotor_bp1'); ?>">
                    ...
                    <div class="form-group row">
                         ...
                         <div class="form-group col-sm">
                              ...
                              <input type="number" step="0.1" min="1.0" max="3.5" class="form-control form-control-sm" id="gph6" name="gph6" value="<?= set_value('gph6'); ?>">
                              <?= form_error('gph6', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="gph7">GPH 7</label>
                              <input type="number" step="0.1" min="1.0" max="3.5" class="form-control form-control-sm" id="gph7" name="gph7" value="<?= set_value('gph7'); ?>">
                              <?= form_error('gph7', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="gph8">GPH 8</label>
                              <input type="number" step="0.1" min="1.0" max="3.5" class="form-control form-control-sm" id="gph8" name="gph8" value="<?= set_value('gph8'); ?>">
                              <?= form_error('gph8', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class="form-group col-sm">
                              <label for="gph9">GPH 9</label>
                              <input type="number" step="0.1" min="1.0" max="3.5" class="form-control form-control-sm" id="gph9" name="gph9" value="<?= set_value('gph9'); ?>">
                    ...
                    <div class="form-group row">
                         <div class="form-group col-sm">
                              ...
                              <input type="number" min="1" max="6" class="form-control form-control-sm" id="regulator1_bp2" name="regulator1_bp2" value="<?= set_value('regulator1_bp2'); ?>">
                              <?= form_error('regulator1_bp2', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class=" form-group col-sm">
                              <label for="regulator2_bp2">Regulator 2</label>
                              <input type="number" min="1" max="6" class="form-control form-control-sm" id="regulator2_bp2" name="regulator2_bp2" value="<?= set_value('regulator2_bp2'); ?>">
                              <?= form_error('regulator2_bp2', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class=" form-group col-sm">
                              <label for="regulator3_bp2">Regulator 3</label>
                              <input type="number" min="1" max="3" class="form-control form-control-sm" id="regulator3_bp2" name="regulator3_bp2" value="<?= set_value('regulator3_bp2'); ?>">
                              <?= form_error('regulator3_bp2', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class=" form-group col-sm">
                              <label for="regulator4_bp2">Regulator 4</label>
                              <input type="number" min="1" max="5" class="form-control form-control-sm" id="regulator4_bp2" name="regulator4_bp2" value="<?= set_value('regulator4_bp2'); ?>">
                              <?= form_error('regulator4_bp2', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class=" form-group col-sm">
                              <label for="regulator5_bp2">Regulator 5</label>
                              <input type="number" min="1" max="5" class="form-control form-control-sm" id="regulator5_bp2" name="regulator5_bp2" value="<?= set_value('regulator5_bp2'); ?>">
                              <?= form_error('regulator5_bp2', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                         <div class=" form-group col-sm">
                              <label for="mainMotor_bp2">Main Motor</label>
                              <input type="number" min="1" max="50" class="form-control form-control-sm" id="mainMotor_bp2" name="mainMotor_bp2" value="<?= set_value('mainMotor_bp2'); ?>">
                              <?= form_error('mainMotor_bp2', '<small class="text-danger pl-3">', '</small>'); ?>
                         </div>
                    </div>
                    <a href="<?= base_url('dashboard/detail/' . $header['id_header']) ?>" class="btn btn-outline-secondary">Kembali</a>
